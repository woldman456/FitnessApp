package com.fitness.fitnessbuddy.security;
import com.fitness.fitnessbuddy.service.MyUserDetailsService;
...
public class SecurityConfigurer extends WebSecurityConfigurerAdapter {
    ...
    protected void configure(HttpSecurity http) throws Exception {
        ...
        http.authorizeRequests().antMatchers(
                        "/auth/users", "/auth/users/login", "/auth/users/register", "/auth/admin/register", "/auth/admin/login").permitAll()
